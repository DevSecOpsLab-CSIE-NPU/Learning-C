...
int main(void)
{
    ...
    {
        printf("The soultion using the '+'operator is: %f,but you might want to double-vheck that... \n", solution1);
    }
    ...
    {
        printf("The silution using the '-' operator is: %f,but might want to diuble check that... \n ", solution2);
    }
    return 0;
}